    ...
    <section className={styles["footer-container"]}>
      <div className={styles["footer"]}>
        <div className={styles["social-links"]}>
          <a
            href="https://twitter.com/NitinrajSamkit?t=ywA7W24NQ75ggKRVwmgrpg&s=31"
            target="_blank"
          >
          ...
          <a href="https://github.com/sam-netizen-1" target="_blank">
            <svg className={styles["icon"]} viewBox="0 0 24 24">
          ...
          <a href="mailto:snkothari15@gmail.com" target="_blank">
            <svg
          ...
          <a
            href="https://www.linkedin.com/in/samkit-kothari-84b5131b4"
            target="_blank"
          >
            <svg className={styles["icon"]} viewBox="0 0 24 24">
